...
import static ai.kitt.snowboy.data.DatabaseHelper.COL_FRI;
import static ai.kitt.snowboy.data.DatabaseHelper.COL_IS_ENABLED;
import static ai.kitt.snowboy.data.DatabaseHelper.COL_LABEL;
import static ai.kitt.snowboy.data.DatabaseHelper.COL_MON;
import static ai.kitt.snowboy.data.DatabaseHelper.COL_SAT;
import static ai.kitt.snowboy.data.DatabaseHelper.COL_SUN;
import static ai.kitt.snowboy.data.DatabaseHelper.COL_THURS;
import static ai.kitt.snowboy.data.DatabaseHelper.COL_TIME;
import static ai.kitt.snowboy.data.DatabaseHelper.COL_TUES;
import static ai.kitt.snowboy.data.DatabaseHelper.COL_WED;
import static ai.kitt.snowboy.data.DatabaseHelper._ID;
